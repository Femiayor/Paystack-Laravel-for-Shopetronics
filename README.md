# Paystack-Laravel-for-Shopetronics
...
```
"shopetronics/laravel-paystack": "1.0.*"
```
...
'providers' => [
    ...
    Shopetronics\Paystack\PaystackServiceProvider::class,
    ...
]
```
...
'aliases' => [
    ...
    'Paystack' => Shopetronics\Paystack\Facades\Paystack::class,
    ...
]
```
...
MERCHANT_EMAIL=xxxxxx@gmail.com
```
